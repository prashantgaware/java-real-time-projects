...
import movieticketbookingservice.paymentservice.dtos.PaymentResultDTO;

import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;

@Service
public class DodoPaymentService {
     ...
     */
    public PaymentResultDTO processPayment(BookingDTO bookingDTO) {
        try {
            // 1. Build the client
